...
export function UsersSection({
  ...
  return (
    <ScreenLayout
      ...
      description="Crea accesos con el mínimo permiso necesario para cada función."
      aside="Solo ADMIN puede consultar y crear usuarios."
    >
      <form
      ...
      <DataTable
        rows={rows}
        columns={["username", "nombre", "rol", "estado"]}
      />
    </ScreenLayout>
  );
}
